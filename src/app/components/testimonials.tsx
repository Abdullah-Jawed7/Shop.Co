  ...
  return (
    <section className="mx-auto max-w-[1240px] px-4 py-12 md:py-16">
      <div className="flex items-center justify-between mb-8 md:mb-12">
        <h2 className={`font-black text-2xl md:text-[32px] `}>
          OUR HAPPY CUSTOMERS
        </h2>
              ...
              <div className="h-full rounded-xl border border-gray-200 bg-white p-6">
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  {testimonial.verified && (
                    <span className="h-4 w-4 rounded-full bg-green-500" ><Check color="#ffffff" width={12} height={12}/></span>
                  )}
                </div>
                <p className={`font-semibold mt-4 text-gray-600 leading-relaxed`}>
                  {testimonial.text}
                </p>
              </div>
            </div>
